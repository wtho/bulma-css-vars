...
function validateOptions(cwd) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    // js output file
    const jsOutputFile = (0, fs_helper_1.getAbsoluteFileName)(
      options.jsOutputFile,
      cwd
    )

    // js output file
    const darkModeJsOutputFile = (0, fs_helper_1.getAbsoluteFileName)(
...
function runCliDarkMode(cwd) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const colorDefs = options.darkModeColorDefs
    ...
    // run generate-vars to have sass information
    const generator = new color_updater_1.ColorGenerator(usedVarsWithColors)
    const sassVarsContent = generator.createWritableDarkModeSassFile()

    // write sass vars output file
    yield (0, fs_helper_1.writeFile)(darkModeSassOutputFile, sassVarsContent)
    console.log(`Updated ${darkModeSassOutputFile}`)

    // write js output file
    let jsOutputContent = `
    module.exports = ${JSON.stringify(
      { bulmaCssVariablesDefs: usedVars },
      null,
      2
    )}
    `
    const fullJsOutputFile = darkModeJsOutputFile.endsWith('.js')
      ? darkModeJsOutputFile
...
exports.runCliDarkMode = runCliDarkMode
